...
Config.Default = {
    permissions = { -- Permissions settings for jailing, unjailing, and other things.
        jail = {
            jobs = {["police"] = 0, ["fbi"] = 0}, -- ["job_name"] = rank_number, ["job_name2"] = rank_number2,
    ...
    outfit = { -- Prisoner outfits to set when in jail. Please change this according to your server's clothing numbers.
        male = {
            ...
            ['torso_1'] = 363, ['torso_2'] = 2,
            ['bproof_1'] = 0,['bproof_2'] = 0,
            ['decals_1'] = 0, ['decals_2'] = 0,
            ['chain_1'] = -1,['chain_2'] = 0,
            ['pants_1'] = 134, ['pants_2'] = 2,
        ...
        female = {
            ...
            ['torso_1'] = 382, ['torso_2'] = 2,
            ['bproof_1'] = 0,['bproof_2'] = 0,
            ['decals_1'] = 0, ['decals_2'] = 0,
            ['chain_1'] = -1,['chain_2'] = 0,
            ['pants_1'] = 141, ['pants_2'] = 2,
...
Config.Activities = {
    ...
    ["clean"] = {
        label = "Job de Nettoyage", -- Will have Start / Stop in front of interaction.
        sections = { -- Sections for this activity.
            ["sweep"] = {
                label = "Nettoyer",
                rewards = { -- Rewards for completing the section.
    ...
    ["kitchen"] = {
        label = "Job de Cuisine", -- Will have Start / Stop in front of interaction.
        sections = { -- Sections for this activity.
            ["stock"] = {
                label = "Récolter les ingrédients",
...
Config.Alerts = function(index, disabled)
    ...
    if (not disabled) then
        ShowNotification("La sirène de la prison a été activée à " .. prison.label .. " !")
    else
        ShowNotification("La sirène de la prison a été désactivée à " .. prison.label .. ".")
    end    
end

Config.Prisons = {
    ["default"] = { -- Default is used as the prison location for players when not defined otherwise.
        label = "Prison Fédéral", -- Prison label for notifications & texts.
        ...
        release = {
            coords = vector3(1853.861, 2586.889, 45.67264),
            heading = 269.4571
        },
        breakout = {
            start = {
                ...
                catalog = {
                    {
                        ...
                        description = "Un excellent outil pour éliminer vos ennemis.",
                        amount = 1,
                        required = {
                    ...
                    {
                        name = "shovel",
                        description = "Peut-être que je pourrais l'utiliser pour m'échapper...",
                        amount = 1,
                        required = {
                            {type = "item", name = "wood", amount = 1},
                            {type = "item", name = "metal", amount = 1},
