Language["en"] = {
    ...
    activity_started = "Vous avez démarré une activité.",
    section_success = "Vous avez réussi cette activité avec succès.",
    section_failure = "Vous avez échoué dans cette activité, essayez à nouveau.",
    interact_far = "Vous êtes trop loin de ce point pour interagir avec lui.",
    interact_breakout = "Commencer l'évasion",
    breakout_success = "Vous avez commencé une évasion, menez les prisonniers vers la liberté !",
    breakout_fail = "Vous avez échoué à vous échapper, essayez à nouveau.",
    breakout_self = "Vous vous êtes échappé de la prison, mais attention, la police vous recherche !",
